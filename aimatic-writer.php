...
define('AIMATIC_UPDATE_URL', 'https://raw.githubusercontent.com/xudevstudio/XU-AIMatic-Plugin/main/update.json');
...
function aimatic_writer_enqueue_scripts($hook) {
    ...
    wp_enqueue_style('aimatic-writer-style', AIMATIC_WRITER_URL . 'assets/style.css', array(), '1.1.1');
    wp_enqueue_script('marked-js', 'https://cdn.jsdelivr.net/npm/marked/marked.min.js', array(), '4.3.0', true);
    wp_enqueue_script('aimatic-writer-script', AIMATIC_WRITER_URL . 'assets/script.js', array('jquery', 'marked-js'), '1.1.1', true);
    ...
    wp_localize_script('aimatic-writer-script', 'aimatic_writer_vars', array(
        ...
        'image_count' => get_option('aimatic_writer_image_count', 1),
        'heading_interval' => get_option('aimatic_writer_heading_interval', 2),
        'nonce' => wp_create_nonce('aimatic_writer_nonce'),
        'ajax_url' => admin_url('admin-ajax.php'),
        'pollinations_width' => get_option('aimatic_writer_pollinations_width', 1200),
        'pollinations_height' => get_option('aimatic_writer_pollinations_height', 632)
    ));
}

        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                 ...
                 <tr valign="top">
                    <th scope="row">Pollinations Image Size</th>
                     <td>
                        <input type="number" name="aimatic_writer_pollinations_width" placeholder="Width" value="<?php echo esc_attr(get_option('aimatic_writer_pollinations_width', 1024)); ?>" class="small-text"> x 
                        <input type="number" name="aimatic_writer_pollinations_height" placeholder="Height" value="<?php echo esc_attr(get_option('aimatic_writer_pollinations_height', 1024)); ?>" class="small-text">
                        <p class="description">Width x Height (Default: 1024x1024)</p>
                     </td>
                </tr>
                 <tr valign="top">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <p class="description">Required for searching and embedding videos (Google Cloud Console).</p>
                    </td>
                </tr>
                <tr valign="top">
